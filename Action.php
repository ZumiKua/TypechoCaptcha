...
class Captcha_Action extends Typecho_Widget implements Widget_Interface_Do
{
	...
	error_log('tes');
        ...
        if ($refererPart['host']!='hm.zumikua.in' || $refererPart['host'] != $currentPart['host'] ||
        0 !== strpos($refererPart['path'], $currentPart['path'])) {
		//echo($refererPart['host']);
            //exit;
	}
	error_log(__DIR__.'/securimage/securimage.php');
